<template>
  <div class="p-20px">
    ...
    <el-table v-loading="loading" :data="list" border stripe>
      ...
      <el-table-column label="处方ID" prop="prescriptionId" width="80" />
      ...
      <el-table-column label="支付状态" width="80">
        <template #default="{ row }">
          <el-tag :type="getDictColorType('hospital_bill_pay_status', row.payStatus)">
            {{ getDictLabel('hospital_bill_pay_status', row.payStatus) }}
          </el-tag>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" width="250" fixed="right">
        <template #default="{ row }">
          ...
          <el-button v-if="row.payStatus === 0" link type="success" @click="handlePay(row.id)">支付</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="500px">
      <el-form :model="formData" label-width="100px">
        ...
        <el-form-item label="处方ID"><el-input v-model.number="formData.prescriptionId" placeholder="请输入处方ID" /></el-form-item>
        <el-form-item label="总金额"><el-input-number v-model="formData.totalAmount" :min="0" :precision="2" /></el-form-item>
      </el-form>
      <template #footer>
...
const list = ref([])
const total = ref(0)
const queryParams = reactive({ pageNo: 1, pageSize: 10, patientId: undefined, payStatus: undefined })
const dialogVisible = ref(false)
const dialogTitle = ref('')
const submitting = ref(false)
const formData = reactive({ id: undefined as any, patientId: undefined as any, visitId: undefined as any, prescriptionId: undefined as any, totalAmount: 0 })
...
const resetQuery = () => { queryParams.patientId = undefined; queryParams.payStatus = undefined; handleQuery() }
...
const openForm = async (type: string, id?: number) => {
  ...
  if (type === 'update' && id) {
    ...
    Object.assign(formData, { id: undefined, patientId: undefined, visitId: undefined, prescriptionId: undefined, totalAmount: 0 })
  }
